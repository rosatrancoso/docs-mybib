...
In \gls{RCM}s the added-value comes from the smaller-scale features introduced by the surfaxe boundary, which is particularly dominant in generating variability as the influence of the lateral conditions diminuish. 
